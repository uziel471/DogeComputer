...
*/
$products = $con->query('select * from ComProductos where ProdNombre like "%'.$busqueda.'%" and ProdDescontinuado="C";');
...
if($salto==4){
	...
	$salto=0;
	 ...
	 echo '<td tyle="text-align: center;"> <img class="../img-responsive" src ="img/'.$r['ProdImagen'].'" width ="180" height = "180"><br>';
